    ...
    >
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          ...
          I'm a front-end developer with one year of React.js experience, dedicated to building scalable web interfaces that offer both exceptional performance and a delightful user experience.
          </p>
